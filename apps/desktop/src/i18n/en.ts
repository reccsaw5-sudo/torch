...
export const en: Translations = {
  ...
  boot: {
    ready: 'Torch Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Torch settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Torch Desktop…'
    },
    errors: {
      backgroundExited: 'Torch background process exited.',
      backgroundExitedDuringStartup: 'Torch background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Torch backend is older than this desktop build and may not work correctly. Update to align them.',
    updateHermes: 'Update Torch',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Torch Desktop.',
    ...
    native: {
      ...
      inputBody: 'Torch is waiting for your response.',
      turnDoneTitle: 'Torch finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Torch defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Torch is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Torch asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Torch was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Torch follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Torch is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Torch, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Torch checks for updates automatically in the background and lets you know when one is ready.',
      ...
      uninstall: {
        ...
        confirmConsequence: consequence => `This removes ${consequence}. This can't be undone.`,
        appLabel: path => `App: ${path}`,
        confirmYes: 'Yes, uninstall',
        uninstalling: 'Uninstalling…',
        cancel: 'Cancel',
        cannotStart: 'Uninstall could not start.',
        heading: 'Uninstall Torch',
        ...
        guiDesc: 'Remove this desktop app. The Torch agent, your config, and chats all stay.',
        guiConsequence: 'the desktop Chat GUI (this app and its data)',
        liteTitle: 'Uninstall GUI + agent, keep my data',
        liteDesc: 'Remove the app and the Torch agent, but keep config, chats, and secrets for a future reinstall.',
        liteConsequence: 'the Chat GUI and the Torch agent (config, chats, and secrets are kept)',
        ...
        fullConsequence:
          'EVERYTHING: the Chat GUI, the Torch agent, and all of your config, chats, secrets, and logs'
      }
    },
    config: {
      none: 'None',
      ...
      loading: 'Loading Torch configuration...',
    ...
    gateway: {
      ...
      intro:
        'Torch Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Torch backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private Torch backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Torch backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      ...
      restartingMessage: 'Torch Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Torch ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Torch runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
    ...
    toolsets: {
      ...
      ready: 'Ready',
      nousIncluded: 'Included with a Torch subscription — sign in to Torch Portal to activate.',
  ...
  starmap: {
    ...
    emptyDesc: 'As Torch builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Torch to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Torch to generate pets.',
      backgroundHint: 'You can close this — Torch will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Torch desktop' },
    ...
    hermesActiveSessions: (version, count) => `Torch ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Torch environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Torch will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Torch backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Torch. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Torch...',
    placeholderReconnecting: 'Reconnecting to Torch…',
    ...
    attachUrlDesc: 'Torch will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Torch to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Torch…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Torch…',
    ...
    unsupportedMessage: 'This version of Torch can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of Torch is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected Torch backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed Torch from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Torch will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Torch desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Torch updater takes over in its own window and reopens Torch automatically when it’s done. Please don’t reopen Torch yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Torch reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Torch reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Torch needs a one-time install',
    ...
    settingUpTitle: 'Setting up Torch Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Torch CLI or desktop instance is running. Stop any running Torch instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Torch installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Torch',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Torch at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Torch connects automatically',
    ...
    authorizeThere: 'Authorize Torch there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Torch there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Pro models need a paid Torch subscription.',
    free: 'Free',
    freeTier: 'Free tier',
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Torch Desktop v${version}`,
      ...
      gatewayTitle: 'Torch inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Torch will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Torch is restarting...',
      askRestart: 'Ask Torch to restart the server',
      lookingRestart: taskId => `Torch is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Torch is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Torch finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Torch could not restart the server.',
      stillWorking:
        'Torch is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Torch is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Torch gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). Torch won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Torch needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Torch needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Torch Desktop to use Save Image.',
    restartToSaveImages: 'Restart Torch Desktop to save images',
