...
const RELEASE_NOTES_URL = 'https://torchai.ai'
...
export function AboutSettings() {
  ...
  if (!supported) {
    // Source-run builds report a raw English reason (e.g. "isn't a git
    // checkout"); show the localized line instead so About stays on-brand.
