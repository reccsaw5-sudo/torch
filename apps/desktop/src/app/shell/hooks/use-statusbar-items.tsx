...
export function useStatusbarItems({
  ...
  const clientVersionItem = useMemo<StatusbarItem>(() => {
    ...
    // End users don't need git internals — keep the tooltip to the product
    // version (+ update status when relevant); commit SHA and branch are dev
    // details that only make sense for the source-install self-update flow.
    const tooltip = [
